...
// // import './toggleswitch.css';   // <-- new CSS for toggle switch
...
//       if (res.ok) {
//         fetchBanners(); // Refresh updated data
//       } else {
...
//   // Export functions
//   const selectedBanners = bannerData.filter((b) => selectedBannerIds.includes(b._id));
...
//     if (!window.confirm("Are you sure you want to delete all selected banners?")) return;
...
//               <tr>
//                 <th><input type="checkbox" checked={currentItems.length > 0 && currentItems.every((b) => selectedBannerIds.includes(b._id))} onChange={toggleAllCheckboxes} /></th>
//                 <th>Banner Name</th>
//                 <th>Banner Image</th>
//                 <th>Status</th>
//                 <th>Actions</th>
...
//             <tbody>
//               {!currentItems.length ? (
//                 <tr><td colSpan="6" className="text-center">No banners found</td></tr>
//               ) : (
//                 currentItems.map((b, idx) => (
//                   <tr key={b._id}>
//                     <td><input type="checkbox" checked={selectedBannerIds.includes(b._id)} onChange={() => toggleCheckbox(b._id)} /></td>
//                     <td>{b.name}</td>
//                     <td><img src={b.image} alt={b.name} style={{ maxWidth: '150px', height: 'auto' }} /></td>
//                     <td>
//                       <div
...
//                       </div>
//                       <div className="toggle-label">{b.enabled ? "ENABLE" : "DISABLE"}</div>
//                     </td>
//                     <td>
//                       <button className="btn btn-sm btn-success  me-2" onClick={() => handleEdit(b)}><FaEdit /></button>
//                       <button className="btn btn-sm btn-danger" onClick={() => handleDelete(b._id)}><FaTrash /></button>
//                     </td>
//                   </tr>
//                 ))
//               )}
...
//               style={{ backgroundColor: "#ff2e56", border: "1px solid #fff", color: "#fff", borderRadius: "10px", border: "none" }}
//             >Previous</button>
//           </li>
