...
import "./bestsellerAll.css"; // Your styles
    ...
    <div className="container mt-4">
      ...
      <div className="row bestsellerAllhead d-flex">
        ...
        {products.map((product) => {
          ...
          return (
            <div className="col-12 col-sm-6 col-md-4 bestsellerAllhead1 mb-4" key={product.id}>
              <div className="card shadow rounded-4 h-100">
                <img
                  src={product.image?.[0] || "/bestseller.png"}
                ...
                <div className="card-body d-flex flex-column justify-content-between">
                  <div>
                    ...
                    <div className="bestsellerAll_weight">{product.weight}</div>
                    <p className="fw-bold">
                      ₹{product.offerPrice}
                      ...
                      {product.discount && (
                        <span className="bestsellerAll-discount ms-2">{product.discount}</span>
                      )}
                    </p>
                    <p className={`bestsellerAll-time ${!available ? "text-danger" : ""}`}>
