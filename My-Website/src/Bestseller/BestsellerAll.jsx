...
const BestsellerAll = () => {
  ...
  // ✅ Fetch all Chicken category products
  useEffect(() => {
    const fetchChickenProducts = async () => {
      try {
        ...
        console.error("Error fetching Chicken products:", err);
      }
    };
    ...
    <>
      ...
      <div className="container mt-4">
        ...
        <div className="row bestsellerAllhead d-flex">
          <h1 className="bestsellerAll-tittle mb-4">Chicken Bestsellers</h1>
